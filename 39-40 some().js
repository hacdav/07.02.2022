...
//rite a function that will ensure that there are Females in the list of employees

function som (val){
    return val.gender === "Male"
}
let returnSom = employees.some(som)
...
function findeEnginie(val){

    return val.isEngineer 
}
let returnSomEnginir = employees.some(findeEnginie)
console.log(returnSom)
