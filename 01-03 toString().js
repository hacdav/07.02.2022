...
let fullName = employees.map(function(val){
  return val.lastName  +  "  " + val.firstName  + " "  
})
console.log(fullName.toString());


let salaryEmail = employees.map((val)=>{
  return val.email +  " : "+ val.salary + " "
})

let saleryEmailTostring = salaryEmail.toString()
console.log(saleryEmailTostring)


function toString(val){
  let dd=[]
  for(let i = 0; i < val.email.length; i++ ){
...
console.log(toString(saleryEmailTostring))