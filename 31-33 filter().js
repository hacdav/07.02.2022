...
function clonArrFilter(val){
    let filter= val.filter((itm)=>{
        return itm
    })
    return filter
}

console.log(clonArrFilter(arr))



//Write a function that will return only employees with salary greater than n
const employees = [
    {
      "firstName": "Arabela",
      "lastName": "Fockes",
...
console.log(filtreSalary(employees.firstName));
